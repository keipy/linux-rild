...
{                                                                       
	...
	if ((!outString) || (!inBuffer) || (nCharLen<=0))
	   return FALSE;

	pUCS2Str = outString;
	while (inBuffer[nLen])
	{
     int nByte1 = (int) inBuffer[nLen];
     bIsUHC = FALSE;
		
		 /* UHC part 1 */
	   if (nByte1 >= 0x81 && nByte1 <= 0xA0)
      {
         int nByte2 = (int) inBuffer[nLen+1];
             ...
             (nByte2 >= 0x81 && nByte2 < 0xFF)) 
        {
            ...
            if (nIndex < 5696) 
            {
               ...
               pUCS2Str[nCnt] = (WORD) (uhc_1_2uni_main_page81[nIdx] + 
            ...
            if ((nByte1 >= 0xA1 && nByte1 <= 0xC6)) 
            {
                   ...
                   (nByte2 >= 0x81 && nByte2 < 0xA1)) 
               {
                  ...
                  if (nIndex < 3126) 
                  {
                     ...
                     pUCS2Str[nCnt] = (WORD)(uhc_2_2uni_main_pagea1[nIdx] + 
      ...
      if (bIsUHC) 
         ...
         pUCS2Str[nCnt] = (WORD) nByte1 < 0x80 ? nByte1 : 0xFFFD; //  ASCII char
